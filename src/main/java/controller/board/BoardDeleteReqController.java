...
public class BoardDeleteReqController implements Controller{
	...
	public void Execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		if(flag!=null) {
			HttpUtil.Forword(req, resp, "/WEB-INF/View/board/isDelete.jsp");;
		}
		else 
		{
			//게시물 패스워드 확인..
			...
			if(curpwd.equals(vo.getPwd())) {
				...
				HttpUtil.Forword(req, resp, "/Board/delete.do?flag=init&num="+num+"&start="+start+"&end="+end+"&nowPage="+nowPage);
			}else {
				//패스워드 불일치
